...
public class DatabaseUtilityBRH {
        ...
        public static Object getCellValue(String query, int row) {
            return getQueryResultList(query).get(row).get(0);
        }
        public static Object getCellValue(int cell, String query) {
            return getQueryResultList(query).get(0).get(cell);
        }
        /**
         *
         * @param query

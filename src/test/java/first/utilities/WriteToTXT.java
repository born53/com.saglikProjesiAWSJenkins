...
//                            + registrant.getPassword() + "," + registrant.getSSN() + ", \n");
    ...
    *//*
    ...
    public static void saveTestData(Test test) {
        ...
        try {
            FileWriter fileWriter = new FileWriter(ConfigReader.getProperty("testFile"), true);
            //src/resource/feature/testdata/RoomData
...
//                            + registrant.getPassword() + "," + registrant.getSSN() + ", \n");
    ...
    public static void saveRegistrantDataDB(Map registrantMap){
        ...
        try {
            FileWriter fileWriter = new FileWriter(ConfigReader.getProperty("registrantFileDB"), true);
            //src/resource/feature/testdata/PatientData
...
//                            + registrant.getPassword() + "," + registrant.getSSN() + ", \n");
    ...
    public static void saveAppointmentDataBase(List<Object> DateIds){
        ...
        try{
            ...
            FileWriter fileWriter = new FileWriter(ConfigReader.getProperty("appointmentDataBase"), true);
...
/*
    ...
    public static void saveTestItemData(Physician physician) {
        try {
            //src/resources/testdata/Registrantdata.txt
            FileWriter fileWriter = new FileWriter(ConfigReader.getProperty("physicianData"), true);
            BufferedWriter writer = new BufferedWriter(fileWriter);
